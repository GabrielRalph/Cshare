...
/**
    irReadValues reads and stores values from the right and left IR sensors on
    PORTA pins 2 and 3 using the function analogRead.
...
/**
    irGetMean takes the stored IR values over the sample period, calculates
